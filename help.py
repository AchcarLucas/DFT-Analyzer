...
def c_help():
    ...
    print(f'-----------------------------------------------------------------')
    print(f'arg signal-analyzer [nome-arquivo-data] [cor] [faixa-frequência-inferior] [faixa-frequência-superior]')
    print(f'  Faz a análise do sinal do arquivo de dados, o argumento [cor] é opcional')
    print(f'  [faixa-frequência-inferior] e [faixa-frequência-superior] são opcionais')
    print(f'  Ex: analyzer ./data/test.data blue 10 50')
    print(f'   O comando acima exibe a onda do arquivo de dados em cor azul na faixa de frequência de 10Hz a 50Hz')
    print(f'-----------------------------------------------------------------')
    print(f'arg signal-data [nome-arquivo-data] [cor] [tempo-inicial] [tempo-final]')
    print(f'  Exibe a forma de onda do arquivo de dados, o argumento [cor] é opcional')
    print(f'  os argumentos [tempo-inicial] [tempo-final] são opcionais, por padrão')
    print(f'  tempo-inicial = 0.0 e o tempo-final é a duração da onda')
    print(f'  Ex: signal-data ./data/test.data blue 0.0 1.0')
    print(f'   O comando acima exibe a onda em cor azul com a exibição do gráfico em 0.0 (s) até 1.0 (s)')
    print(f'-----------------------------------------------------------------')
